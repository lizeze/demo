...
function initBt3() {
    ...
    bt.addEventListener('mouseleave', function () {
        ...
        for (var i = 0; i < particles.length; i++) {
            ...
            TweenLite.to(particles[i], 0.6, {
                x: 0, scaleX: 1, ease: Power3.easeOut, onComplete: function () {
    ...
    bt.addEventListener('click', function () {
        ...
        TweenLite.to(bt.querySelectorAll('.button__bg'), 0.9, {
            scale: 1, ease: Elastic.easeOut.config(1.2, 0.4), delay: 0.1,
            onComplete: function () {
                clicked = false;
            },
...
function initBt4() {
    ...
    bt.addEventListener('mouseup', function (e) {
        ...
        Array.prototype.slice.call(blob, 1).forEach(function (bt) {
            var tl = new TimelineLite();
            tl.to(bt, 1.2, {
                x: dirX * r * Math.random() + '%',
                y: dirY * r * Math.random() + '%',
...
function initBt9() {
    ...
    bt.addEventListener('click', function (e) {
        TweenLite.set(turb, {
            attr: {
                x: isFF ? e.offsetX : e.offsetX + 20,
                y: isFF ? e.offsetY : e.offsetY + 20,
                width: 0,
                height: 0
            }
        });
